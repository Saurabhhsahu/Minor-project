...
function Login() {
    ...
    return (
        <form 
            ...
            className='border border-gray-400 max-w-[400px] mx-auto mt-20 mb-20 p-8 rounded-lg'>
            ...
            <button 
                ...
                type='submit' className='w-full bg-primary text-white py-2 px-4 mt-4 rounded-md cursor-pointer'>{state === 'Sign Up' ? "Create Account" : "Login"}</button>
